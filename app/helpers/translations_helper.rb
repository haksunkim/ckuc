module TranslationsHelper
  ...
  def en_keys
    [ "header.menu.home", "header.menu.about", "header.menu.service", "header.menu.group", "header.menu.news", "header.menu.blog", "header.menu.contact", "page.title", "footer.item1.title", "footer.item1.content", "footer.item2.title", "footer.item2.content", "footer.item3.title", "footer.item3.content", "home.title", "home.subtitle", "home.tab.item1.title", "home.tab.item1.content", "home.tab.item2.title", "home.tab.item2.content", "home.tab.item3.title", "home.tab.item3.content", "home.tab.item4.title", "home.tab.item4.content", "home.tab.item5.title", "home.tab.item5.content", "home.tab.item6.title", "home.tab.item6.content", "about.title", "about.list.item1.title", "about.list.item1.content", "about.list.item2.title", "about.list.item2.content", "about.list.item3.title", "about.list.item3.content", "about.list.item4.title", "about.list.item4.content", "about.list.item5.title", "about.list.item5.content" ]
  end
